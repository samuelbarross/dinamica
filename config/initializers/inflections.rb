...
ActiveSupport::Inflector.inflections do |inflect|
  ...
  inflect.irregular "system_permition", "system_permitions"
  inflect.irregular "system_action", "system_actions"
  inflect.irregular "system_controller_action", "system_controller_actions"
  inflect.irregular "system_controller", "system_controllers"
  inflect.irregular "system_controller_query", "system_controller_queries"
  inflect.irregular "system_controller_action_query", "system_controller_action_queries"
  inflect.irregular "campeonato_fase", "campeonato_fases"
  #
  inflect.irregular "contabil", "contabeis"
  inflect.irregular "cancel", "cancels"
end
