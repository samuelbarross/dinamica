        ...
        children: [
          {
            ...
            children: [
              {
                href: coordenacao_pedagogicas_path  ,
                title: 'Cordenação Pedagógica'
              },
              {
                href: atividade_complementares_path,
              ...
              {
                href: planejamento_pedagogicos_path,
                title: 'Planejamento Pedagógicos'
              },
              {
                href: capitulos_path,
                title: 'Capítulos'
