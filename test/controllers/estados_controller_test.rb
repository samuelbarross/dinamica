...
class EstadosControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create estado" do
    assert_difference('Estado.count') do
      post estados_url, params: { estado: { codigo_ibge: @estado.codigo_ibge, nome: @estado.nome, sigla: @estado.sigla } }
    end
  ...
  test "should update estado" do
    patch estado_url(@estado), params: { estado: { codigo_ibge: @estado.codigo_ibge, nome: @estado.nome, sigla: @estado.sigla } }
