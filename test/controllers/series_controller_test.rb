...
class SeriesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create series" do
    assert_difference('Serie.count') do
      post series_url, params: { series: { codigo: @series.codigo, nivel_id: @series.nivel_id, nome: @series.nome } }
    end
  ...
  test "should update series" do
    patch series_url(@series), params: { series: { codigo: @series.codigo, nivel_id: @series.nivel_id, nome: @series.nome } }
