...
class ContratosControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create contrato" do
    assert_difference('Contrato.count') do
      post contratos_url, params: { contrato: { ano_letivo_id: @contrato.ano_letivo_id, prefeitura_id: @contrato.prefeitura_id } }
    end
  ...
  test "should update contrato" do
    patch contrato_url(@contrato), params: { contrato: { ano_letivo_id: @contrato.ano_letivo_id, prefeitura_id: @contrato.prefeitura_id } }
