...
class LivrosControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create livro" do
    assert_difference('Livro.count') do
      post livros_url, params: { livro: { ano_edicao: @livro.ano_edicao, nome: @livro.nome, serie_id: @livro.serie_id, volume: @livro.volume } }
    end
  ...
  test "should update livro" do
    patch livro_url(@livro), params: { livro: { ano_edicao: @livro.ano_edicao, nome: @livro.nome, serie_id: @livro.serie_id, volume: @livro.volume } }
