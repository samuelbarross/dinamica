...
class MateriasControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create materia" do
    assert_difference('Materia.count') do
      post materias_url, params: { materia: { codigo: @materia.codigo, nome: @materia.nome } }
    end
  ...
  test "should update materia" do
    patch materia_url(@materia), params: { materia: { codigo: @materia.codigo, nome: @materia.nome } }
