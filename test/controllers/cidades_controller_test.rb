...
class CidadesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create cidade" do
    assert_difference('Cidade.count') do
      post cidades_url, params: { cidade: { codigo_ibge: @cidade.codigo_ibge, estado_id: @cidade.estado_id, nome: @cidade.nome } }
    end
  ...
  test "should update cidade" do
    patch cidade_url(@cidade), params: { cidade: { codigo_ibge: @cidade.codigo_ibge, estado_id: @cidade.estado_id, nome: @cidade.nome } }
